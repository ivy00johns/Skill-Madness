...
A multi-agent orchestration toolkit for Claude Code — 62 OSS-publishable skills in `skills/`. Skills are symlinked to `~/.claude/skills/` for global availability.
