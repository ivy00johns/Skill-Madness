...
name: full-agent
version: 2.1.0
description: Apply full-agent when you need a role skill with every documented frontmatter field populated, for testing field-stripping behavior across all 11 tools.
owns:
  directories:
    - tests/installer/fixtures/output/
  patterns:
    - "*.fixture"
  shared_read:
    - contracts/
