...
composes_with: ["orchestrator", "fix-until-green", "orchestrator-task-loop", "contract-conformance-loop", "babysit", "coverage-loop", "perf-loop", "self-healing-loop", "migration-loop", "qe-agent", "contract-auditor", "diagnose-loop", "context-manager", "loop", "schedule"]
