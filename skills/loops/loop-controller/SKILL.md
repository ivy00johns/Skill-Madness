...
composes_with: ["orchestrator", "fix-until-green", "orchestrator-task-loop", "contract-conformance-loop", "babysit", "qe-agent", "contract-auditor", "diagnose-loop", "context-manager", "loop", "schedule"]
